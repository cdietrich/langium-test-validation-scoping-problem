...
export interface HelloWorld2AstType {
    Greeting: Greeting
    Model: Model
    Person: Person
}

export class HelloWorld2AstReflection extends AbstractAstReflection {
...
export const reflection = new HelloWorld2AstReflection();
